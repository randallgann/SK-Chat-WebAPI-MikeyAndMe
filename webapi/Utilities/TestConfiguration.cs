...
public sealed class TestConfiguration
{
    ...
    private static T LoadSection<T>([CallerMemberName] string? caller = null)
    {
        ...
        return s_instance._configRoot.GetSection(caller).Get<T>() ??
               throw new ConfigurationNotFoundException($"Configuration section '{caller}' not found.", section: caller);
    }
...
internal class ConfigurationNotFoundException : Exception
{
    ...
    public ConfigurationNotFoundException(string? message, string section) : base(message)
    {
    }
